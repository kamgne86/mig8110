...
from arguments import command, url, output_file_key, input_file_key, table_name, schema_name
...
@table_name
@schema_name
def main(command, output_file_key, url, input_file_key, table_name, schema_name):

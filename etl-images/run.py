...
from arguments import command, url, output_file_key, input_file_key, table_name, schema_name, num_files, invalid_file_key, mode, last_processed_file
...
@mode
@last_processed_file
def main(command, output_file_key, url, input_file_key, invalid_file_key, table_name, schema_name, num_files, mode, last_processed_file):
    if command == "extract_data":
        ...
        load_data(input_file_key, table_name, schema_name, mode)
    elif command == "extract_delta":
        extract_delta(output_file_key, url, num_files, last_processed_file)
